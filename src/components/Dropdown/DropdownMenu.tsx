  ...
  return (
    <div
      class={classNames(props.class, {
        "transition-[opacity,margin] duration hs-dropdown-open:opacity-100 min-w-[6rem] bg-white shadow-md rounded-lg p-2 mt-2 divide-y divide-gray-200 dark:bg-gray-800 dark:border dark:border-gray-700 dark:divide-gray-700": true,

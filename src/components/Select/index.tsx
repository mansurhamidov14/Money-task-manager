    ...
    <div class={localProps.containerClass}>
      <div class="relative">
        <select
          ...
          classList={{
            "block w-full rounded-t-lg px-3 pb-2 pt-6 text-sm font-medium bg-secondary-50 dark:bg-secondary-700 border-0 border-b-2 appearance-none dark:text-white focus:outline-none focus:ring-0 placeholder-transparent focus:placeholder-secondary-400 peer": true,
            "ps-10 inset-0.5": Boolean(localProps.addonStart),
        ...
        <label
          ...
          classList={{
            ...
            "ps-10 start-2.5": Boolean(localProps.addonStart),
            "start-3": !Boolean(localProps.addonStart),
